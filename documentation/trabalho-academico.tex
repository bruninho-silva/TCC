...
\include{pre-textual/capa}						% Inserir Capa
...
\chapter{Visão de Negócio}
	\includepdf[pages=-]{pos-textual/1vn.pdf}
\chapter{Avaliação da Organização}
	\includepdf[pages=-]{pos-textual/2ao.pdf}
\chapter{Documento de Arquitetura de Negócios}
	\includepdf[pages=-]{pos-textual/3dqn.pdf}
\chapter{Plano de Gerenciamento de Requisitos}
	\includepdf[pages=-]{pos-textual/4pgr.pdf}
\chapter{Visão}
\includepdf[pages=-]{pos-textual/5v.pdf}
\chapter{Especificação de Caso de Uso}
\includepdf[pages=-]{pos-textual/6uc.pdf}
\chapter{Arquitetura de Software}
\includepdf[pages=-]{pos-textual/7as.pdf}


\chapter{Documentação da Biblioteca}
\includepdf[pages=-]{pos-textual/DecisionMakerLPA.pdf}
\chapter{Documentação do Game Design}
\includepdf[pages=-]{pos-textual/game-design.pdf}
